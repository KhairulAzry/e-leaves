...
<form name="users_dept" action="view_users_process.php" method="post">
<p class="only_bold">You can use this form to view records for all users in a specific department.</p>
      <div class="small_spacer"></div>

    <div class="form_label_float">Department:</div>
   <div class="form_field_float">
   <select name="users_dept">
   		<option value="<?php echo $manager_dept;?>" selected="selected"><?php echo $manager_dept;?></option>
