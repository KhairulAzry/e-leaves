...
<div class="page_title">New users applications</div>
...
echo "<p>User has been approved. User can now login to the system and apply for new leaves. Please do not forget to update the user's profile with his/her leaves credits.</p>";
}
else
{
...
echo "<div class=clearall></div>";
echo "<p>An error has occurd. It looks like the user you have tried to approve does not belong in your department. If you think this is an error, please contact the adminstration staff.</p>";
...
echo "<div class=floataftericon_red>An error has occurd</div>";
echo "<div class=clearall></div>";
echo "<p>An error has occurd. It looks like the user you have tried to approve does not exist in the database. Please try again. If the error persist, please contact the admin staff.</p>";
