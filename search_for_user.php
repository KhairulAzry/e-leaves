...
<form id="edit_user_search" name="edit_user" action="edit_user.php" method="post">




<div>
<p>Enter the username or the ID of the user you wish to edit or update:</p>
<div>
<input class="required" type="text" name="search1" id="search1"/></div>
