...
echo "<p>An error has occurd. It looks like the application you have tried to reject does not belong in your department. If you think this is an error, please contact the adminstration staff.</p>";
}
...
echo "Leave was successfully rejected<br><br></div>";
echo "<div class=clearall></div>";
echo "<p>Leave with $leave_ref was successfully rejected.<br><br>The applicant was sent an automatic E-mail notification regarding the rejection of the leave. </p>";
