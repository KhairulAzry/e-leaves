...
$zero=mysql_query("UPDATE `users` SET `$string_leave_type` = '0' WHERE `users`.`id` =$applicants_id;") or die ("An error occurd. We are trying our best to fix this as soon as possible. Sorry for any inconvenience");
