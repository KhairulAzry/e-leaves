...
<form action="cancel_leave2.php" method="post" name="cancel_leave" id="cancel_leave">




<div>
<p>Enter the refernce number of the leave you want to cancel:</p>
</div>
<div>
<input class="required digits" type="text" name="reference_no" id="reference_no"/></div>
<div><input class="form_button_style" type="submit" name="button2" id="button2"  value="Cancel leave"  /></div>
</div>
