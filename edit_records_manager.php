...
$result=mysql_query("SELECT * FROM `users` WHERE `yearly_adjust` = '1' AND `department` = '$manager_dept'") or die ("An error occurd. We are trying our best to fix this as soon as possible. Sorry for any inconvenience");
