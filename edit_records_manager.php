...
$result=mysqli_query("SELECT * FROM `users` WHERE `yearly_adjust` = '1' AND `department` = '$manager_dept'") or die ("An error occurd. We are trying our best to fix this as soon as possible. Sorry for any inconvenience");
...
if ($number_of_pages > 0)
{
		...
		if ($current_page>1)
		{
			...
			echo "<a href=edit_records_manager.php?page=$i>
			Previous</a>";
			echo "</div>";
