...
<div class="page_title">View leaves by user</div>

<div class="content_wrapping_small">


<form id="user_leave" name="user_leave" action="leave_specific_user.php" method="post">

<p class="only_bold">Enter the ID or the username of the employee and select the date range that you wish to check.</p>
      <div class="small_spacer"></div>

    <div class="form_label_float">ID / Username:</div>
   <div class="form_field_float">


<input type="text" name="applicants_id" id="applicants_id" class="required" />
...
<div class="view_leaves_button">
<input class="form_button_style" type="submit" name="View Leaves" id="View Leaves" value="View Leaves" />
</div>
